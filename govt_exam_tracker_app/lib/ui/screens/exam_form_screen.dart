          ...
          Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Row(children: [Expanded(child: _buildStageToggle('Mains / CBT-2', _hasMains, (v) => _hasMains = v)), Expanded(child: _buildStageToggle('Skill / Physical', _hasSkillTest, (v) => _hasSkillTest = v))]),
                Row(children: [Expanded(child: _buildStageToggle('Interview', _hasInterview, (v) => _hasInterview = v)), Expanded(child: _buildStageToggle('Doc Verification', _hasDV, (v) => _hasDV = v))]),
