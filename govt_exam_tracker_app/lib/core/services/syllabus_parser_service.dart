...
class SyllabusParserService {
  ...
  static Future<String> _callDualEngineAi(String systemPrompt, String userPrompt, String userApiKey) async {
    ...
    if (isGemini) {
      ...
      else throw Exception('Gemini Error: ${response.statusCode}');
    } else {
      final url = Uri.parse('https://api.groq.com/openai/v1/chat/completions');
      final requestBody = {"model": "llama-3.3-70b-versatile", "messages": [{"role": "system", "content": systemPrompt}, {"role": "user", "content": userPrompt}], "temperature": 0.1};
      ...
      else throw Exception('Groq Error: ${response.statusCode}');
    }
  }
